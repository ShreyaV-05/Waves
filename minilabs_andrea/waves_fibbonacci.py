...
class Fibonacci:
    ...
    def __init__(self, series):
        ...
        self._series = series  # initializing the series, the "n"th number
        self._list = []        # initializing the list, the first second set of data in the output
        self._dict = {}        # initializing the dictionary, going through each fibonacci sequence
        self._dictID = 0
        # Duration timeElapsed;
        # Instant start = Instant.now();  // time capture -- start
        self.calc_series()    # calling the function on line 20 which is inside the class
