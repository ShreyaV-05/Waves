...
#books.app.config['SECRET_KEY'] = 'Books'
#books.app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = True
#books.app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///books.db'  # telling program where to put the database
...
@books_bp.route('/')
def index():
    return render_template("genretemp.html")
